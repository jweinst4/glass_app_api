...
class StudiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create studio" do
    assert_difference('Studio.count') do
      post studios_url, params: { studio: { code: @studio.code, description: @studio.description, image: @studio.image, name: @studio.name, price: @studio.price } }, as: :json
    end
  ...
  test "should update studio" do
    patch studio_url(@studio), params: { studio: { code: @studio.code, description: @studio.description, image: @studio.image, name: @studio.name, price: @studio.price } }, as: :json
    assert_response 200
  end
